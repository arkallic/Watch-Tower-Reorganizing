...
class ModerationManager:
    def __init__(self, config, logger):
        ...
        self.script_dir = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))  # Go up three levels
        ...
        self.case_manager = CaseManager(self.cases_dir, self.user_data, logger)
    ...
    def get_moderation_summary(self, days: int = 30):
        # Update statistics manager with current data
    ...
    # Main coordination methods remain here
    async def create_moderation_case(self, user_id: int, action_data: Dict[str, Any]) -> int:
        ...
        # Create case
        case_number = self.case_manager.create_case(user_id, action_data)
